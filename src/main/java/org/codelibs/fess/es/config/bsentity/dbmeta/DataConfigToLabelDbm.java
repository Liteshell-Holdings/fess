...
public class DataConfigToLabelDbm extends AbstractDBMeta {
    ...
    public String getEntityTypeName() {
        return "org.codelibs.fess.es.config.exentity.DataConfigToLabel";
    }

    @Override
    public String getConditionBeanTypeName() {
        return "org.codelibs.fess.es.config.cbean.DataConfigToLabelCB";
    }

    @Override
    public String getBehaviorTypeName() {
        return "org.codelibs.fess.es.config.exbhv.DataConfigToLabelBhv";
    }
