...
public class WebConfigToLabelDbm extends AbstractDBMeta {
    ...
    public String getEntityTypeName() {
        return "org.codelibs.fess.es.config.exentity.WebConfigToLabel";
    }

    @Override
    public String getConditionBeanTypeName() {
        return "org.codelibs.fess.es.config.cbean.WebConfigToLabelCB";
    }

    @Override
    public String getBehaviorTypeName() {
        return "org.codelibs.fess.es.config.exbhv.WebConfigToLabelBhv";
    }
